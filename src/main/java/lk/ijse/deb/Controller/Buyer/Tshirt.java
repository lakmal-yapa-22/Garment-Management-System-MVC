...
public class Tshirt {
    ...
    private void    loadAllProductTShirtLogTshirt() {
        ...
        try {
            List<Product> productList = ProductRepo.getAllProductTshirtLongTshirt();
    ...
    public void btnReportTshirtOnAction(ActionEvent actionEvent) throws JRException, SQLException {
        JasperDesign jasperDesign = JRXmlLoader.load("src/main/resources/report/AllTshirt.jrxml");
