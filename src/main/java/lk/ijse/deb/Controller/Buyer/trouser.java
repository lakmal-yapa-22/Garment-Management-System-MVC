...
public class trouser {
    ...
    private void  loadAllProductTrouser() {
        ...
        try {
            List<Product> productList = ProductRepo.getAllTrouser();
    ...
    public void backPageOnAction(ActionEvent actionEvent) throws IOException {
    ...
    public void btnReportTrouserOnAction(ActionEvent actionEvent) throws JRException, SQLException {
        JasperDesign jasperDesign = JRXmlLoader.load("src/main/resources/report/AllTrouser.jrxml");
